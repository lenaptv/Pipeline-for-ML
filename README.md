...
В таком случае было бы здорово автоматизировать данную работу. Именно это и делает данная программа.
...
Данная программа автоматизирует процесс машинного обучения для следующего определенного случая.
Рассмотрим пример, если бы для онлайн школы было бы важно предсказать день недели, в котором был сделан определенный коммит в зависимости от следующих признаков: студента, номера лабораторной работы, часа и порядкового номера попытки.
При этом есть таблица со следующей информацией: 
